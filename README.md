...
This is a barebones implementation of a flight simulator using JSBSim and C++. At the moment, it's tested on Ubuntu 24.04 and is unlikely to run on dissimilar OS's.
